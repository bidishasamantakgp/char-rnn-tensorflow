...
def main():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.002,
                        help='learning rate')
    parser.add_argument('--wordembed', type=bool, default=False,
                        help='if word by word prediction')
    ...
    parser.add_argument('--gpu_mem', type=float, default=0.666,
                        help='gpu memory to be allocated to this process')
...
def train(args):
    data_loader = TextLoader(args.data_dir, args.batch_size, args.seq_length, args.wordembed)
